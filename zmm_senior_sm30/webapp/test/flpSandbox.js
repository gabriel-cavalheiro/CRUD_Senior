		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manutenção de Tipos de Pedidos",
									"targetURL": "#zmmseniorsm30zmmseniorsm30-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmseniorsm30zmmseniorsm30-display": {
								"semanticObject": "zmmseniorsm30zmmseniorsm30",
								"action": "display",
								"description": "SM30 de Tipos de Pedidos do Senior",
								"title": "Manutenção de Tipos de Pedidos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmseniorsm30.zmmseniorsm30",
									"url": sap.ui.require.toUrl("zmmseniorsm30/zmmseniorsm30")
								}
							}
						}
					}
